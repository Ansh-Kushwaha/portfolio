  ...
  return (
    <>
      ...
      >
        ...
        and have also gained a strong foundation in mathematics and problem-solving.<br /> <br className='sm:hidden block'/>
        I have experience in developing responsive and visually appealing user interfaces 
        using HTML, CSS, Javascript, Kotlin and Java. <br /> <br className='sm:hidden block'/>
